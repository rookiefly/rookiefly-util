...
public interface RedisService {
     ...
     * @param key                键
     * @param value              值
     * @param expireMilliSeconds 过期时间毫秒
     * @return true 设置成功 false 键已存在
     * @throws JedisConnectionException 若和redis服务器的连接不成功
     */
     ...
     *
     * @param key   hashtalbe的key
     * @param field hashtable的 field
     * @param value 要设置的值
     ...
     *
     * @param key                 键
     * @param expectingOriginVals 期望的旧值
     * @param toBe                期望更新的值
