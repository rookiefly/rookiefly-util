package com.rookiefly.test.commons.lottery;

import com.rookiefly.commons.lottery.Arithmetic;
import com.rookiefly.commons.lottery.Prize;
...
public class Test {
    public static void main(String[] args) {
        ...
        prize1.setPrizeId(1);
        prize1.setProbability(new BigDecimal(0.00005));
        ...
        Arithmetic arithmetic = new Arithmetic(prizes);
        int times = 100000;
        for (int i = 0; i < times; i++) {
            int prizeId = arithmetic.lottery();
            switch (prizeId) {
                case 1:
                    prize1GetTimes++;
                    break;
